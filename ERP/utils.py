...
def event_process_eeg_files(file_list, base_path, base_path_ica, standard_channels, trigger_id='100'):
    """
...
def plot_tfr_bands(epochs, bands=None, freqs_range=(1, 100, 0.5), isplot = True):
    """
...
def plot_grand_average_bands(ga_task, ga_base, bands=None):
    """
...
def plot_tfr_bands_topomap(tfr_data, ga_evoked, band_list=None, t_start=-0.5, t_stop=0.0, cmap='RdBu_r'):
    """
